...
<head>
    ...
    <title>Register - CakeAdmin Bootstrap 5 Demo</title>
                ...
                <div class="row g-0">
                        ...
                        <div class="row">
                            <div class="col-md-10 offset-md-1">
                                ...
                                <form action="{{ route('register') }}" method="POST" class="mb-5">
                                    @csrf
                                    <div class="mb-3">
                                        <input type="text" name="name" class="form-control" placeholder="Enter fullname" autofocus required>
                                        @error('name')
                    ...
                    <div class="col d-none d-lg-flex border-start align-items-center justify-content-between flex-column text-center">
                        ...
                        <div>
                            ...
                            <a class="btn btn-primary" href="{{ route('login.form') }}">Sign In</a>
                        </div>
