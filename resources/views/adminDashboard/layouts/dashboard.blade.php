        ...
        <div class="dropdown">
            <a href="#" class="d-flex align-items-center" data-bs-toggle="dropdown">
                <div class="avatar me-3">
                    <img src="{{ Auth::user()->image ? asset('storage/' . Auth::user()->image) : asset('images/user/man_avatar3.jpg') }}" alt="User Image" class="rounded-circle" width="100">

                </div>
                <div>
                    <div class="fw-bold">@if(Auth::check())
                {{ Auth::user()->name }}!
            @else
                Welcome, Guest!
            @endif</div>
            ...
            <div class="dropdown-menu dropdown-menu-end">
               <a href="{{ route('users.edit', auth()->user()->id) }}" class="dropdown-item d-flex align-items-center">
...
<a href="#" class="dropdown-item d-flex align-items-center text-danger" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
    <i class="bi bi-box-arrow-right dropdown-item-icon"></i> Logout
        ...
        <ul>
            ...
            <li>
                <a  class="{{ Route::is('index') ? 'active' : '' }}"  href="{{ route('index') }}">
            ...
            <li>
             ...
             <li>
                <a  class="{{ Route::is('manageUsers') ? 'active' : '' }}"  href="{{ route('manageUsers') }}">
                    <span class="nav-link-icon">
                        <i class="bi bi-person-circle"></i>
                    </span>
                    <span>Users</span>
            ...
            <li>
                ...
                <ul>
                    <li>
                        <a  href="{{ route('manageUsers') }}">List View</a>
                    </li>
                    <li>
...
<div class="layout-wrapper">
    ...
    <a href="./dashboard.html" class="logo">
        <img width="100" src="{{ asset('logo.png') }}" alt="logo">
    </a>
    <!-- ./ Logo -->
...
<script src="{{ asset('js/examples/users.js') }}"></script>
