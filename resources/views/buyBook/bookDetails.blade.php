    ...
    <section class="tp-product-details-area pt-100">
       <div class="tp-product-details-top pb-115">
          <div class="container">
             <div class="row">
                <div class="col-lg-6">
                    <div class="tp-shop-product-thumb p-relative" style="height: 100%; display: flex; justify-content: center; align-items: center; background-color: #f9f9f9;">
                        <a href="">
      ...
      <div class="row">
         <div class="col-lg-12">
            <div class="tp-product-related-heading text-center mb-30">
               <h4 class="tp-product-related-title">Similar Books</h4>
            </div>
         </div>
      </div>
      <div class="row">
         @foreach ($relatedBooks as $inventory)
