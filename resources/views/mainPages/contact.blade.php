         ...
         <div class="col-lg-10">
            <div class="tp-contact-wrap p-relative">
               ...
               <div class="tp-contact-from-box">
                  ...
                  <form id="contact-form" action="assets/mail.php" method="post" onsubmit="return validateForm(event)">
                     <div class="tp-contact-input-form">
                        <div class="row">
                           ...
                           <div class="tp-contact-btn">
                              <button type="submit" class="tp-btn-inner" style="
                              border-radius: 0;
                              color: #DDF49F;
                              padding: 6px 22px;
...
function validateForm(event) {
                ...
                <div class="row">
                   ...
                   <div class="col-lg-4 col-md-6">
                      <div class="tp-contact-info-item mb-30">
                         ...
                         <a href="tel:0797879006">+962 797879006</a>
                      </div>
                   </div>
                   <div class="col-lg-4 col-md-6">
                    <div class="tp-contact-info-item mb-30">
                        ...
                        <!-- Link to Google Maps -->
                        <a href="https://www.google.com/maps/place/Salt+Institute+for+careers+traditional+crafts/@32.0420373,35.7421141,17z/data=!3m1!4b1!4m6!3m5!1s0x151ca2aa6c9505af:0xc1d8fa75aade030f!8m2!3d32.0420328!4d35.744689!16s%2Fg%2F11c60mjhg5?entry=ttu&g_ep=EgoyMDI0MTAxNi4wIKXMDSoASAFQAw%3D%3D" target="_blank">Slat ,Jo #33-01</a>
                    </div>
                </div>
             </div>
          </div>
    ...
    <div class="tp-map-area">
       <div class="tp-contact-map-content">
        <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3404.467736015765!2d35.7421141!3d32.0420373!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151ca2aa6c9505af%3A0xc1d8fa75aade030f!2sSalt%20Institute%20for%20careers%20traditional%20crafts!5e0!3m2!1sen!2sjo!4v1697536349694!5m2!1sen!2sjo"
        width="600"
        height="450"
        style="border:0;"
        allowfullscreen=""
