...
<main>
    ...
    <!-- login area start -->
    <section class="tp-login-area mt-60 mb-60">
          ...
          <div class="tp-login-register-wrapper d-flex justify-content-center align-items-center">
            ...
            @endif
                <div class="tp-login-from-heading text-center">
                   ...
                   <p>Dont have an account? <a href="{{ route('register.form') }}">Create Now</a></p>
                </div>
                   ...
                   <div class="row">
                      ...
                      <div class="col-12">
                         ...
                         <div class="tp-login-from-btn">
                            <button type="submit" class="w-100 text-center" style="
                            border-radius: 0;
                            color: #DDF49F;
                            padding: 6px 22px;
                            ...
                            height: 55px;
                             font-size: 15px;
                                 font-weight: 600;
                            box-shadow: 0px 1px 2px 0px rgba(1, 99, 90, 0.25), 0px 0px 1px 0px #01635A;">Sign In</button>
                         </div>
